function scr_add_vehicle(vehicle_type, target_company, weapon1, weapon2, weapon3, upgrade, accessory) 
	{
		...
		if (good != 0)
		{
		    ...
		    if (obj_ini.fleet_type = 1)
				{
					obj_ini.veh_loc[target_company][good] = obj_ini.home_name;obj_ini.veh_wid[target_company][good] = 2; obj_ini.veh_lid[target_company][good] = 0;
				}
			...
			if (weapon1 = "standard") and (weapon2 = "standard") and (weapon3 = "standard")
				{
					...
					if (vehicle_type = "Land Speeder")
						{
							obj_ini.veh_wep1[target_company][good] = "Heavy Bolter";obj_ini.veh_wep2[target_company][good] = "";obj_ini.veh_upgrade[target_company][good] = "";
						}
				}
