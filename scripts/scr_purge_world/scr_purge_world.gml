function scr_purge_world(argument0, argument1, argument2, argument3) {
	...
	if (argument2=2){// Burn baby burn
	    ...
	    if (isquest=1){
	        if (thequest="cleanse") and (argument3>=20){
	            ...
	            scr_event_log("","Inquisition Mission Completed: The mutants of "+string(argument0.name)+" "+string(scr_roman(argument1))+" have been cleansed by promethium.");
	...
	if (argument2=3){// Blam!
	    ...
	    if (isquest=1){
	        if (thequest="purge") and (argument3>=10){
	            ...
	            scr_event_log("","Inquisition Mission Completed: The unruly Nobles of "+string(argument0.name)+" "+string(scr_roman(argument1))+" have been purged.");
	            scr_gov_disp(argument0.name,argument1,choose(1,2,3));
	        }
	    }
	    if (isquest=0){
