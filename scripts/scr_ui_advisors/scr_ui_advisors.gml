	...
	if (menu=16){
	    ...
	    if (instance_exists(cn)){
	        ...
	        if (cn.temp[101]!=""){
	            ...
	            if (cn.temp[110]!=""){draw_text(xx+383,yy+701,string_hash_to_newline("-"+string(cn.temp[110])+" ("+string(cn.temp[111])+")"));}
	            if (cn.temp[112]!=""){draw_text(xx+383,yy+719,string_hash_to_newline("-"+string(cn.temp[112])+" ("+string(cn.temp[113])+")"));}
	            if (cn.temp[114]!=""){draw_text(xx+383,yy+737,string_hash_to_newline("-"+string(cn.temp[114])+" ("+string(cn.temp[115])+")"));}
	            if (cn.temp[116]!=""){draw_text(xx+383,yy+755,string_hash_to_newline("-"+string(cn.temp[116])+" ("+string(cn.temp[117])+")"));}
